...
export function FounderCommandClient({
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-[12px] border border-[var(--color-primary)]/40 bg-[var(--color-primary)]/5 p-6">
...
function WorkflowStepCard({
  ...
  return (
    <div className="flex flex-col rounded-[12px] border border-[var(--color-border)] bg-[var(--color-card)] p-4">
...
function SnapshotCount({
  ...
  return (
    <div className="rounded-[8px] border border-[var(--color-border)] bg-[var(--color-background)] p-2">
